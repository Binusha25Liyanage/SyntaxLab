...
const defaultStops = ['#8E0D17', '#C1121F', '#E8E8E8'];
...
export default function Aurora({
  ...
  useEffect(() => {
    ...
    const update = (t) => {
      ...
      const { speed: currentSpeed, blend: currentBlend, amplitude: currentAmplitude, colorStops: currentStops } = propsRef.current;
